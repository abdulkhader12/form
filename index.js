let tod = new Date();
let year = tod.getFullYear();
let Dat = tod.getDate();
let Mon = tod.getMonth() + 1; //January is 0 so need to aDat 1 to make it 1!
if (Dat < 10) {
    Dat = '0' + Dat
}
if (Mon < 10) {
...
maxDate = year - 18 + '-' + Mon + '-' + Dat;
minDate = year - 55 + '-' + Mon + '-' + Dat;
...
const saveUserForm = (event) => {
    ...
    displayEntries(); // ADat this line
};

let form = document.getElementById("user_form");
form.aDatEventListener("submit", saveUserForm, true);
displayEntries();